...
|                                         |                      |               MIG M. |
|=========================================+======================+======================|
|   0  NVIDIA L20                     Off | 00000000:4B:00.0 Off |                    0 |
| N/A   39C    P0              76W / 350W |  40840MiB / 46068MiB |      0%      Default |
|                                         |                      |                  N/A |
+-----------------------------------------+----------------------+----------------------+
|   1  NVIDIA L20                     Off | 00000000:65:00.0 Off |                    0 |
| N/A   42C    P0              78W / 350W |  42488MiB / 46068MiB |      0%      Default |
|                                         |                      |                  N/A |
+-----------------------------------------+----------------------+----------------------+
|   2  NVIDIA L20                     Off | 00000000:B1:00.0 Off |                    0 |
| N/A   39C    P0              78W / 350W |  42488MiB / 46068MiB |      0%      Default |
|                                         |                      |                  N/A |
+-----------------------------------------+----------------------+----------------------+
|   3  NVIDIA L20                     Off | 00000000:E3:00.0 Off |                    0 |
| N/A   46C    P0              83W / 350W |  40840MiB / 46068MiB |      0%      Default |
|                                         |                      |                  N/A |
+-----------------------------------------+----------------------+----------------------+
...
|        ID   ID                                                             Usage      |
|=======================================================================================|
|    0   N/A  N/A      8537      C   VLLM::Worker_TP0                          40834MiB |
|    1   N/A  N/A     26467      C   VLLM::Worker_TP0                          42482MiB |
|    2   N/A  N/A     26468      C   VLLM::Worker_TP1                          42482MiB |
|    3   N/A  N/A      8538      C   VLLM::Worker_TP1                          40834MiB |
+---------------------------------------------------------------------------------------+(test_softmax);
    RUN(test_rms_norm);
    RUN(test_matmul);
    RUN(test_silu);
